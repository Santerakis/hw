...
const defaultAffairs: AffairType[] = [ // need to fix any
    ...
    {_id: 5, name: 'html & css & js', priority: 'middle'},
]

// pure helper functions
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any
    //let filAffairs = affairs
    if (filter === 'high') {
        //filAffairs =
    ...
    return affairs//affairs // need to fix
}
export const deleteAffair = (affairs: Array<AffairType>, _id: number): Array<AffairType> => { // need to fix any

    return affairs.filter(affair => affair._id !== _id)//affairs // need to fix
}
...
function HW2() {
    ...
    return (
        <div id={'hw2'}>
            <div className={s2.hwTitle}>Homework_#2</div>
            <div className={s2.hw}>
                <Affairs
